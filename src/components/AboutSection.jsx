...
const AboutSection = () => {
    ...
    return (
        ...
        <section ref={sectionRef}  id="about" className="h-screen relative overflow-hidden bg-gradient-to-b from-black to-[#9a74cf50]">
            <div className="flex flex-col items-center justify-center h-full">
                <h1 ref={titleRef} className="text-3xl md:text-6xl font-bold sm:mb-16 text-center my-0 text-white opacity-0">
                    About Me
                </h1>
            </div>
            <div ref={abtref} className="left-0 right-0 flex items-center justify-center mx-auto my-auto">
                <h3 className="text-white text-lg md:text-2xl text-center max-w-3xl mx-auto px-4">
